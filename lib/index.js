...
exports.getCurrencyGraph = exports.globalMarket = exports.tickerByAsset = exports.ticker = undefined;
...
let getCurrencyGraph = exports.getCurrencyGraph = (() => {
  var _ref4 = _asyncToGenerator(function* (opts) {
    const res = yield fetch(`https://graphs2.coinmarketcap.com/currencies/${opts.currencyName}/${opts.startTs}/${opts.endTs}`);
    return res.json();
  });

  return function getCurrencyGraph(_x5) {
